...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, HardwareConstants.ID_LEFT_FRONT_MOTOR);
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, HardwareConstants.ID_LEFT_BACK_MOTOR);
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, HardwareConstants.ID_RIGHT_BACK_MOTOR);
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, HardwareConstants.ID_RIGHT_FRONT_MOTOR);
