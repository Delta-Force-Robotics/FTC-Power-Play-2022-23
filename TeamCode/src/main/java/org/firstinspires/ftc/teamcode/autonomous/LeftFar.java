...
public class LeftFar extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        trajToIntake = drive.trajectorySequenceBuilder(new Pose2d(-4, -16.5, Math.toRadians(135)))
                .splineToSplineHeading(new Pose2d(-23, -11.5, Math.toRadians(180)), Math.toRadians(180))
                .splineToSplineHeading(new Pose2d(-64, -11.5, Math.toRadians(180)), Math.toRadians(180))
                .build();

        trajToScore = drive.trajectorySequenceBuilder(trajToIntake.end())
                .setTangent(Math.toRadians(180))
                .splineToSplineHeading(new Pose2d(-23, -11.5, Math.toRadians(180)), Math.toRadians(0))
                .splineToSplineHeading(new Pose2d(-4, -16.5, Math.toRadians(135)), Math.toRadians(-30))
                .build();
