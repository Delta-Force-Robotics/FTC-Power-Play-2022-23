...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 6.618255615234319; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 6.1417323; // in; offset of the lateral wheel
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        ...
        lateralEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, HardwareConstants.ID_LATERAL_ENCODER));
