...
public class RightFar extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        trajPreload = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                ...
                .splineToSplineHeading(new Pose2d(28, -7, Math.toRadians(-45)), Math.toRadians(135),
                        SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(35))
                .build();

        trajToIntake = drive.trajectorySequenceBuilder(new Pose2d(4, -16.5, Math.toRadians(60)))
                .splineToSplineHeading(new Pose2d(23, -11.5, Math.toRadians(0)), Math.toRadians(0))
        ...
        trajToScore = drive.trajectorySequenceBuilder(trajToIntake.end())
                ...
                .splineToSplineHeading(new Pose2d(23, -11.5, Math.toRadians(0)), Math.toRadians(180))
                .splineToSplineHeading(new Pose2d(4, -16.5, Math.toRadians(60)), Math.toRadians(225))
                .build();
