...
public class Constants {
    ...
    public static final int SLIDE_MID_JUNCTION = -1936;
    public static final int SLIDE_LOW_JUNCTION = -1108;
    public static final int SLIDE_HIGH_JUNCTION = -2830;
    public static final int SLIDE_INTERMEDIARY = -12;
    public static final int SLIDE_INTAKE = -5;
    ...
    public static final double INTAKE_SLIDE_EXTENDED_SLIDE = 0.04;
    ...
    //public static double TURRET_I = 0; disabled for now
    //public static double TURRET_D = 0; disabled for now
