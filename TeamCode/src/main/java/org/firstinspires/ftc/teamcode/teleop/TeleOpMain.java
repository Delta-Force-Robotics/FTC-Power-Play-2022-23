...
public class TeleOpMain extends CommandOpMode {
    ...
    public void initialize() {
        ...
        new GamepadButton(driver2, GamepadKeys.Button.DPAD_UP).whenPressed(() -> slideThreadExecutor.accept(Constants.SLIDE_POSITIONS_CONESTACK[0]));
        new GamepadButton(driver2, GamepadKeys.Button.DPAD_LEFT).whenPressed(() -> slideThreadExecutor.accept(Constants.SLIDE_POSITIONS_CONESTACK[1]));
        new GamepadButton(driver2, GamepadKeys.Button.DPAD_RIGHT).whenPressed(() -> slideThreadExecutor.accept(Constants.SLIDE_POSITIONS_CONESTACK[2]));
        new GamepadButton(driver2, GamepadKeys.Button.DPAD_DOWN).whenPressed(() -> slideThreadExecutor.accept(Constants.SLIDE_POSITIONS_CONESTACK[3]));
