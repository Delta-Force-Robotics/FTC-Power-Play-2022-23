...
public class PIDFController {
    ...
    private double maxErrorIntegration;
    ...
    public double getMaxErrorIntegration() {
        return maxErrorIntegration;
    }

    public void setMaxErrorIntegration(double maxErrorIntegration) {
        this.maxErrorIntegration = maxErrorIntegration;
    }
}
