...
public class Left extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        trajToIntake = drive.trajectorySequenceBuilder(new Pose2d(-28, -7, Math.toRadians(225)))
        ...
        trajToScore = drive.trajectorySequenceBuilder(trajToIntake.end())
                ...
                .splineToSplineHeading(new Pose2d(-28, -4, Math.toRadians(225)), Math.toRadians(30),
                        SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(35))
                .build();
